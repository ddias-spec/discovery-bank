...
const BDR_CLOSING = {
  ...
  sections: [
    ...
    { id: "bdr_barriers", label: "Contract Length", placeholder: "Lock-in period? End date? Any break clauses?…", noPain: true, noGoal: true, noNotes: true,
      dropdown: true, dropdownType: "contract", options: ["No contract", "Monthly rolling", "Inside 3 months", "6 months", "12 months", "12+ months", "Unknown"], dropdownPlaceholder: "Contract length…" },
